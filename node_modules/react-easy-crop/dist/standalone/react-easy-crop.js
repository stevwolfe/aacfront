...
function (_React$Component) {
  ...
  function Cropper() {
    ...
    _this.setInitialCrop = function () {
      ...
      var _getInitialCropFromCr = getInitialCropFromCroppedAreaPixels(initialCroppedAreaPixels, _this.imageSize),
    ...
    _this.computeSizes = function () {
      if (_this.image) {
        ...
        var cropSize = _this.props.cropSize ? _this.props.cropSize : getCropSize(_this.image.width, _this.image.height, _this.props.aspect, _this.props.rotation);
    ...
    _this.onDrag = function (_ref2) {
      ...
      _this.rafDragTimeout = window.requestAnimationFrame(function () {
        ...
        var newPosition = _this.props.restrictPosition ? restrictPosition(requestedPosition, _this.imageSize, _this.state.cropSize, _this.props.zoom, _this.props.rotation) : requestedPosition;
    ...
    _this.setNewZoom = function (zoom, point) {
      ...
      var newPosition = _this.props.restrictPosition ? restrictPosition(requestedPosition, _this.imageSize, _this.state.cropSize, newZoom, _this.props.rotation) : requestedPosition;
    ...
    _this.emitCropData = function () {
      ...
      var restrictedPosition = _this.props.restrictPosition ? restrictPosition(_this.props.crop, _this.imageSize, _this.state.cropSize, _this.props.zoom, _this.props.rotation) : _this.props.crop;

      var _computeCroppedArea = computeCroppedArea(restrictedPosition, _this.imageSize, _this.state.cropSize, _this.getAspect(), _this.props.zoom, _this.props.rotation, _this.props.restrictPosition),
    ...
    _this.recomputeCropPosition = function () {
      var newPosition = _this.props.restrictPosition ? restrictPosition(_this.props.crop, _this.imageSize, _this.state.cropSize, _this.props.zoom, _this.props.rotation) : _this.props.crop;
